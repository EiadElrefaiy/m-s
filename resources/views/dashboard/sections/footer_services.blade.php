                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Footer Services</strong>
                                <strong class="table-db" style="display:none;">footer_services</strong>
                                <strong class="view" style="display:none;">dashboard.sections.footer_services</strong>

                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Steps</strong>
                                <strong class="table-db" style="display:none;">steps</strong>
                                <strong class="view" style="display:none;">dashboard.sections.steps</strong>

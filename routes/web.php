...
Route::get('/blog/{id}',  [App\Http\Controllers\Website\BlogController::class, 'read'])->name('readBlog');
Route::get('/blogs',  [App\Http\Controllers\Website\BlogController::class, 'index'])->name('getBlogs');
